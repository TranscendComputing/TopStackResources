...
# Register an instance with load balancer using haproxy
# input config, account, loadBalancer, instances
# return instanceId
...
<#list loadBalancer.listeners as lisn>
  ...
  <#if lisn.protocol=="http" || lisn.protocol=="HTTP">
...
Daemon 1
  ...
  <#list loadBalancer.listeners as lisn>
	...
	<#assign lbport=lisn.loadBalancerPort />
	<#assign instport=lisn.instancePort />
  	<#if lisn.protocol=="https" || lisn.protocol=="HTTPS" >
ListenHTTPS
Address ${lbdns}
